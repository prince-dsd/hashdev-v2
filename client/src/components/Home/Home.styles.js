...
export const BackgroundImageContainer = styled.div`
    ...
    object-fit: cover;
    height: 100vh;
    clip-path: polygon(0% 0%, 100% 0%, 100% 90rem, 0% 90rem);
    overflow: hidden;
...
export const BackgroundImage = styled.div`
    ...
    background-image: radial-gradient(
        ...
        radial-gradient(
            ...
            rgba(241, 241, 241, 0.04) 50%,
            rgba(241, 241, 241, 0.04) 100%
        ),
        radial-gradient(
            circle at 44% 60%,
            rgba(175, 175, 175, 0.04) 0%,
            rgba(175, 175, 175, 0.04) 50%,
            rgba(185, 185, 185, 0.04) 50%,
            rgba(187, 187, 187, 0.04) 100%
        ),
        linear-gradient(19deg, rgb(4,164,190), rgb(5,56,181));
`;
...
export const SignUpContainer = styled.div`
    ...
    padding: 2.4rem;
    background: #f4f5f7;
    box-shadow: 0 0.4rem 0.8rem -0.2rem rgba(9,30,66,0.25), 0 0 0.1rem rgba(9,30,66,0.31);
  ${media.bp1040`
        display:none;
    `}
