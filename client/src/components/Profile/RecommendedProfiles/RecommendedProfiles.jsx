...
import { selectRecommendedProfiles, fetchRecommendedProfiles } from 'redux/profiles';
import defaultAvatar from 'assets/img/profile/avatar/default-thumbnail.jpeg';
import * as S from './RecommendedProfiles.styles';

const propTypes = {
    fetchRecommendedProfiles: PropTypes.func.isRequired,
