...
exports.createProfileAdmin = commonService.createOne(Profile);
exports.updateProfile = commonService.updateOneByUserId(Profile);
exports.getProfile = commonService.getOneByUserId(Profile, { errorMessage: notFoundErrorMessage });
exports.deleteProfile = commonService.deleteOneByUserId(Profile, { errorMessage: notFoundErrorMessage });
exports.getAllProfiles = commonService.getAll(Profile);
exports.deleteProfile = commonService.deleteOneByUserId(Profile, { errorMessage: notFoundErrorMessage });
